        ...
        <div>
            <div class="hero ">
                ...
                data-aos-duration="900"/>
                    <div>
                        <h1 class="text-5xl font-bold" data-aos="fade-left"
                ...
                data-aos-duration="900">G Series equips you with all the essentials you need to experience split-second responsiveness and immersive gameplay.</p>
                        ...
                        <div><button class="btn btn-primary rounded-none mb-4 px-12" data-aos="zoom-in"
                data-aos-duration="900">Shop G Series</button></div>
                        <div><button class="btn btn-outline btn-primary rounded-none px-12" data-aos="zoom-in"
                data-aos-duration="900">Shop G Series</button></div>
                        </div>
                    </div>
                </div>
